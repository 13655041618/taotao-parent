...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://localhost:8082/rest/item/cat/list?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://localhost:8081" + c), '<a href="' + c + '">' + d + "</a>")
